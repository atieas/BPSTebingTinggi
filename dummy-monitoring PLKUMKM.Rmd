---
title: "Progress PLKUMKM Kota Tebing Tinggi Kondisi Oktober 2023"
...
Show_slsflag %>% filter(Koseka=="Sungkono") %>% kable(booktabs = T, align = "c",
               ...
               Progress Flag SLS Selesai Oktober 2023 Pukul 04.00WIB - PER PCL di Tim Sungkono
               </strong></center>") %>%
...
Show_slsflag %>% filter(Koseka=="M. Akhyar") %>% kable(booktabs = T, align = "c",
               caption = "<center><strong>
               Progress Flag SLS Selesai Oktober 2023 Pukul 04.00WIB - PER PCL di Tim Akhyar
               </strong></center>") %>%
  kable_styling(fixed_thead = T) %>%
...
Show_slsflag %>% filter(Koseka=="Lutfi") %>% kable(booktabs = T, align = "c",
               caption = "<center><strong>
               Progress Flag SLS Selesai Oktober 2023 Pukul 04.00WIB - PER PCL di Tim Lutfi
               </strong></center>") %>%
  kable_styling(fixed_thead = T) %>%
...
Show_slsflag %>% filter(Koseka=="Tukimin") %>% kable(booktabs = T, align = "c",
               caption = "<center><strong>
               Progress Flag SLS Selesai Oktober 2023 Pukul 04.00WIB - PER PCL di Tim Tukimin
               </strong></center>") %>%
  kable_styling(fixed_thead = T) %>%
...
Show_slsflag %>% filter(Koseka=="Mahyuly Suaidah Siregar") %>% kable(booktabs = T, align = "c",
               caption = "<center><strong>
               Progress Flag SLS Selesai Oktober 2023 Pukul 04.00WIB - PER PCL di Tim Mahyuly
               </strong></center>") %>%
  kable_styling(fixed_thead = T) %>%
...
Show_slsflag %>% filter(Koseka=="Elina Maisyarah") %>% kable(booktabs = T, align = "c",
               caption = "<center><strong>
               Progress Flag SLS Selesai Oktober 2023 Pukul 04.00WIB - PER PCL di Tim Elina
               </strong></center>") %>%
  kable_styling(fixed_thead = T) %>%
...
usaha_petugas_20okt2023 %>% filter(Koseka=="Sungkono") %>%
  ...
  kable(booktabs = T, align = "c", caption = "<center><strong>
        Progress Realisasi Usaha Oktober 2023 - PER PCL di Tim Sungkono
               </strong></center>") %>%
  kable_styling(fixed_thead = T) %>%
...
-   **Putih (normal)** berarti progress realisasi sudah minimal `r round(((30-0)/30*100),2)`% atau termasuk **"Ideal"** untuk per tanggal Oktober 2023
...
Show %>% kable(align = "c", "html",
               caption = "<center><strong>
               Summary Progress Oktober 2023 Pukul 04.00WIB - PLKUMKM Tebing Tinggi
               </strong></center>") %>%
...
Show_Koseka %>% kable(booktabs = T, align = "c",
               caption = "<center><strong>
               Progress Lapangan Oktober 2023 Pukul 04.00WIB - PER KOSEKA
               </strong></center>") %>%
  kable_styling(fixed_thead = T) %>%   
...
Progress_Lapangan_PML %>% kable(booktabs = T,align = "c",
               caption = "<center><strong>
               Summary Progress Lapangan Oktober 2023 Pukul 04.00WIB - PER PML
               </strong></center>") %>%
  kable_styling(fixed_thead = T) %>%   
...
Progress_Approval_PML %>% kable(booktabs = T,align = "c",
               caption = "<center><strong>
               Progress APPROVAL Oktober 2023 Pukul 04.00WIB - PER PML
               </strong></center>") %>%
  kable_styling(fixed_thead = T) %>%   
...
ggplot(Progress_Approval_PML %>% filter(Koseka=="Sungkono"),
  ...
  ggtitle("Progress Approval Per PML Pada Tim Sungkono [Oktober 2023 04.00WIB]")  +
  theme_classic() +
...
ggplot(Progress_Approval_PML %>% filter(Koseka=="M. Akhyar"),
  ...
  facet_wrap(~Koseka, scales = "free_y", ncol = 1)+
  xlab("Nama Petugas") +  ylab("Progress Approval (%)") +
  ggtitle("Progress Approval Per PML Pada Tim M. Akhyar [Oktober 2023 04.00WIB]")  +
  theme_classic() +
  theme(plot.margin = margin(t = 1, r = 1, b = 1, l = 0, unit = "cm"),
    axis.title.x = element_text(size = 9), axis.title.y = element_text(size = 9),
    plot.title = element_text(size=11))
...
ggplot(Progress_Approval_PML %>% filter(Koseka=="Lutfi"),
  ...
  facet_wrap(~Koseka, scales = "free_y", ncol = 1)+
  xlab("Nama Petugas") +  ylab("Progress Approval (%)") +
  ggtitle("Progress Approval Per PML Pada Tim Lutfi [Oktober 2023 04.00WIB]")  +
  theme_classic() +
  theme(plot.margin = margin(t = 1, r = 1, b = 1, l = 0, unit = "cm"),
    axis.title.x = element_text(size = 9), axis.title.y = element_text(size = 9),
    plot.title = element_text(size=11))
...
ggplot(Progress_Approval_PML %>% filter(Koseka=="Tukimin"),
  ...
  facet_wrap(~Koseka, scales = "free_y", ncol = 1)+
  xlab("Nama Petugas") +  ylab("Progress Approval (%)") +
  ggtitle("Progress Approval Per PML Pada Tim Tukimin [Oktober 2023 04.00WIB]")  +
  theme_classic() +
  theme(plot.margin = margin(t = 1, r = 1, b = 1, l = 0, unit = "cm"),
    axis.title.x = element_text(size = 9), axis.title.y = element_text(size = 9),
    plot.title = element_text(size=11))
...
ggplot(Progress_Approval_PML %>% filter(Koseka=="Mahyuly Suaidah Siregar"),
  ...
  facet_wrap(~Koseka, scales = "free_y", ncol = 1)+
  xlab("Nama Petugas") +  ylab("Progress Approval (%)") +
  ggtitle("Progress Approval Per PML Pada Tim Mahyuly [Oktober 2023 04.00WIB]")  +
  theme_classic() +
  theme(plot.margin = margin(t = 1, r = 1, b = 1, l = 0, unit = "cm"),
    axis.title.x = element_text(size = 9), axis.title.y = element_text(size = 9),
    plot.title = element_text(size=11))
...
ggplot(Progress_Approval_PML %>% filter(Koseka=="Elina Maisyarah"),
  ...
  facet_wrap(~Koseka, scales = "free_y", ncol = 1)+
  xlab("Nama Petugas") +  ylab("Progress Approval (%)") +
  ggtitle("Progress Approval Per PML Pada Tim Elina [Oktober 2023 04.00WIB]")  +
  theme_classic() +
  theme(plot.margin = margin(t = 1, r = 1, b = 1, l = 0, unit = "cm"),
    axis.title.x = element_text(size = 9), axis.title.y = element_text(size = 9),
    plot.title = element_text(size=11))
...
Progress_Lapangan_PCL %>% kable(booktabs = T,align = "c",
               caption = "<center><strong>
               Progress Lapangan Oktober 2023 Pukul 04.00WIB - PER PCL
               </strong></center>") %>%
  kable_styling(fixed_thead = T) %>%   
...
ggplot(Progress_Lapangan_PCL %>% filter(Koseka=="Sungkono"),
  ...
  ggtitle("Progress Realisasi Lapangan Per PCL Pada Tim Sungkono [Oktober 2023 04.00WIB]")  +
  theme_classic() +
  theme(plot.margin = margin(t = 1, r = 1, b = 1, l = 0, unit = "cm"),
    axis.title.x = element_text(size = 9), axis.title.y = element_text(size = 9),
    plot.title = element_text(size=11))
...
ggplot(Progress_Lapangan_PCL %>% filter(Koseka=="M. Akhyar"),
  ...
  facet_wrap(~Koseka, scales = "free_y", ncol = 1)+
  xlab("Nama Petugas") +  ylab("Progress Realisasi (%)")+
  ggtitle("Progress Realisasi Lapangan Per PCL Pada Tim M. Akhyar [Oktober 2023 04.00WIB]")  +
  theme_classic() +
  theme(plot.margin = margin(t = 1, r = 1, b = 1, l = 0, unit = "cm"),
    axis.title.x = element_text(size = 9), axis.title.y = element_text(size = 9),
    plot.title = element_text(size=11))
...
ggplot(Progress_Lapangan_PCL %>% filter(Koseka=="Lutfi"),
  ...
  facet_wrap(~Koseka, scales = "free_y", ncol = 1)+
  xlab("Nama Petugas") +  ylab("Progress Realisasi (%)")+
  ggtitle("Progress Realisasi Lapangan Per PCL Pada Tim Lutfi [Oktober 2023 04.00WIB]")  +
  theme_classic() +
  theme(plot.margin = margin(t = 1, r = 1, b = 1, l = 0, unit = "cm"),
    axis.title.x = element_text(size = 9), axis.title.y = element_text(size = 9),
    plot.title = element_text(size=11))
...
ggplot(Progress_Lapangan_PCL %>% filter(Koseka=="Tukimin"),
  ...
  facet_wrap(~Koseka, scales = "free_y", ncol = 1)+
  xlab("Nama Petugas") +  ylab("Progress Realisasi (%)")+
  ggtitle("Progress Realisasi Lapangan Per PCL Pada Tim Tukimin [Oktober 2023 04.00WIB]") +
  theme_classic() +
...
ggplot(Progress_Lapangan_PCL %>% filter(Koseka=="Mahyuly Suaidah Siregar"),
  ...
  facet_wrap(~Koseka, scales = "free_y", ncol = 1)+
  xlab("Nama Petugas") +  ylab("Progress Realisasi (%)")+
  ggtitle("Progress Realisasi Lapangan Per PCL Pada Tim Mahyuly [Oktober 2023 04.00WIB]") +
  theme_classic() +
  theme(plot.margin = margin(t = 1, r = 1, b = 1, l = 0, unit = "cm"),
    axis.title.x = element_text(size = 9), axis.title.y = element_text(size = 9),
    plot.title = element_text(size=11))
...
ggplot(Progress_Lapangan_PCL %>% filter(Koseka=="Elina Maisyarah"),
  ...
  facet_wrap(~Koseka, scales = "free_y", ncol = 1)+
  xlab("Nama Petugas") +  ylab("Progress Realisasi (%)")+
  ggtitle("Progress Realisasi Lapangan Per PCL Pada Tim Elina [Oktober 2023 04.00WIB]")  +
  theme_classic() +
  theme(plot.margin = margin(t = 1, r = 1, b = 1, l = 0, unit = "cm"),
    axis.title.x = element_text(size = 9), axis.title.y = element_text(size = 9),
    plot.title = element_text(size=11))
